...
export interface Vyper_contractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "multiSendEther"
      | "multiSendToken"
...
export interface Vyper_contract extends BaseContract {
  connect(runner?: ContractRunner | null): Vyper_contract;
  waitForDeployment(): Promise<this>;

  interface: Vyper_contractInterface;
